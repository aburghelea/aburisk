...
<!--    </p>-->
    ...
    <div class="clearfix" style="margin-top: 10px">
        <a href="javascript:void(0);" class="button-style" onclick="ABURISK.game.changeInnerState();" style="margin-top: 0 !important;">&gt;&gt;End
            turn</a>

        <a href="javascript:void(0);" class="join-style" onclick="ABURISK.game.doAttack();">ATTACK</a>
    </div>
</form>